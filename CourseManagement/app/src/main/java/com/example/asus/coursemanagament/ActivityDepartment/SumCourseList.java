    ...
    private void showDialog1(int i) {   //显示课程信息对话框
        ...
        builder.setPositiveButton("保存", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Log.i("tableName",zhuanye);
                Tb_teacher_declare tt;
                List<Tb_teacher_declare> ll = new ArrayList<Tb_teacher_declare>();
                String after1;
                String after2;
                    ...
                    if (lt2.size() != 0) {
                        for (int k = 0; k < lt2.size(); k++) {
                            ...
                            if ((k == lt2.size() - 1) && !lt.get(i).equals(lt2.get(k))) {
                                tt = new Tb_teacher_declare(zhuanye, tb_course.getC_name(), tb_course.getGrade(),
                                        "","",lt.get(i),  "");
                                Log.i("lt-----", lt.get(i));
                                ll.add(tt);
                            }
